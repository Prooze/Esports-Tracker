...
router.post('/', checkPermission('manage_tournaments'), (req, res) => {
...
router.put('/:id', checkPermission('manage_tournaments'), (req, res) => {
...
router.get('/completion-log', checkPermission('manage_tournaments'), (_req, res) => {
